...
var host = "34.168.174.38";    //from GCloud instance (change to match your db)
var database = "CHEESECAKE";  //database name
var user = "kwon25";         //username (change to match your db)
var password = "helloWorld123";  //password (change to match your db, yes this is very poor practice)
